...
var testinterval = setInterval(web.scrapHtml_mutnam, 10*60*1000);
var testinterval = setInterval(web.scrapHtml_purple, 10*60*1000);
var testinterval = setInterval(web.scrapHtml_withyoon, 10*60*1000);
