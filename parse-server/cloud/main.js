...
var testinterval = setInterval(web.scrapHtml_mutnam, 2*60*60*1000);
var testinterval = setInterval(web.scrapHtml_purple, 2*60*60*1000);
var testinterval = setInterval(web.scrapHtml_withyoon, 2*60*60*1000);
