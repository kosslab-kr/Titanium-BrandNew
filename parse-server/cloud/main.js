...
var testinterval = setInterval(web.scrapHtml_mutnam, 3*60*60*1000);
var testinterval = setInterval(web.scrapHtml_purple, 3*60*60*1000);
var testinterval = setInterval(web.scrapHtml_withyoon, 3*60*60*1000);
